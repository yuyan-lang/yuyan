...
# 文言：网站之器皆由今源生之。汉语：先构建当前原生编译器与 WasmGC 宿主，再生成浏览器所需静态资源。
.PHONY: 浏览器编译资源
浏览器编译资源: yy4_bs yy豫构
	$(MAKE) 网页汇编宿主 网页汇编宿主编译器=./yy4_bs
	./yy豫构 构建 豫言编译器 --编译器 ./yy4_bs --输出 yy浏览器种子.wasm -- --target=wasmgc
	./yy豫构 构建 浏览器编译资源 --编译器 ./yy4_bs --输出 yy浏览器编译资源
