...
struct
    ...
    *)
    ...
    (* val labeledTypeCompConsOp  = Operators.parseOperatorStr "夫〇建〇" false false 400 [1] *)
    (* val namedProdTypeOp  = Operators.parseOperatorStr "〇合〇" true false 380 [] *)
    ...
    val allTypeAndExprOps = allTypeOps @ [ 
        ...
        (* lazyProjExprOp,
        lazyPairExprOp, injExprOp, foldExprOp, unfoldExprOp,  *)
        caseClauseOp, 
        caseAlternativeOp, caseExprOp, ifThenElseExprOp, implicitAppExprOp, 
        (* packExprOp, unpackExprOp,  *)
        lambdaExprOp,
