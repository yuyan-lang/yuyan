...
exception CPSInternalError
    ...
    fun configureAndCpsTransformSigTopLevel (getCPSInfo : FileResourceURI.t -> cpsvar) :
    context -> CSignature -> cpsvar -> cpscomputation = 
    let
